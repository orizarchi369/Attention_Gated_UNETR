...
parser.add_argument("--data_dir", default="/dataset/dataset0/", type=str, help="dataset directory") # These are defaults and need to be adjusted for my specific dataset. Ori
parser.add_argument("--json_list", default="dataset_0.json", type=str, help="dataset json file") # These are defaults and need to be adjusted for my specific dataset. Ori
parser.add_argument(
...
parser.add_argument("--out_channels", default=2, type=int, help="number of output channels") # Adjusted it to 2. Ori
...
parser.add_argument("--space_x", default=1, type=float, help="spacing in x direction") # Adjusted these to 1 (space_x and y and z). Ori
