# trainer.py
# I haven't changed anything in this file, this is the original code from the repository. Ori
...
def save_checkpoint(model, epoch, args, filename="model.pt", best_acc=0, optimizer=None, scheduler=None):
    ...
    print("Saving checkpoint", filename) # I previously had problems with saving checkpoints when running training in Colab. I had the training results but didn't see the saved models so I couldn't use them to test the model on my test set. Ori
